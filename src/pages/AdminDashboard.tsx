...
const stats = [
  { label: "Total", value: mockGrievances.length, icon: FileText, color: "text-primary" },
  { label: "Solved", value: mockGrievances.filter((g) => g.status === "Solved").length, icon: CheckCircle, color: "text-success" },
  { label: "In Progress", value: mockGrievances.filter((g) => g.status === "In Progress").length, icon: Clock, color: "text-warning" },
  { label: "Not Solved", value: mockGrievances.filter((g) => g.status === "Not Solved").length, icon: AlertCircle, color: "text-destructive" },
];
